...
<img alt="not found" src="https://technoelevate.com/images/logo.png" style="width:3cm;height:3cm  ">
<%if(msg!=null && !msg.isEmpty()){ %>
<h2 style="color:red;text-align:center;padding-left:400px "><%=msg%></h2>
  <%} %>
  <%if(mess!=null && !mess.isEmpty()){ %>
<h2 style="color:red;text-align:center;padding-left:400px"><%=mess%></h2>
  <%} %>
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form>
      <input type="text" id="login" class="fadeIn second" name="empId" placeholder="empId" required="required">
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="inactive underlineHover" href="http://localhost:8084/union/ragisration">New user? Create new account</a>
    </div>
